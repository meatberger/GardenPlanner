...
Objects0=$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IntermediateDirectory)/Classes_Overlaps.cpp$(ObjectSuffix) $(IntermediateDirectory)/Classes_GardenBed.cpp$(ObjectSuffix) $(IntermediateDirectory)/Classes_Shape.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/Classes_GardenBed.cpp$(ObjectSuffix): Classes/GardenBed.cpp $(IntermediateDirectory)/Classes_GardenBed.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/berger/Documents/GardenPlanner/Garden/Garden/Classes/GardenBed.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Classes_GardenBed.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Classes_GardenBed.cpp$(DependSuffix): Classes/GardenBed.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Classes_GardenBed.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Classes_GardenBed.cpp$(DependSuffix) -MM Classes/GardenBed.cpp

$(IntermediateDirectory)/Classes_GardenBed.cpp$(PreprocessSuffix): Classes/GardenBed.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Classes_GardenBed.cpp$(PreprocessSuffix) Classes/GardenBed.cpp
